...
//    circleView.layer.cornerRadius = sizeCircle / 2.;
    ...
    dotImageView.frame = CGRectMake(2, 4, 16, 16);
    dotImageView.image = [UIImage imageNamed:@"fullheart"];
}
...
- (void)reloadData
{
    ...
    dotImageView.hidden = ![self.calendarManager.dataCache haveEvent:self.date];
